	...
	pt: {
		translations: {
			...
			homePageTitles: {
				pt1: "Oi! Me chamo ",
				pt2: "Bruno",
				pt3: "Seu dev frontend.",
			},
			homePageDescription: {
				text: "Gosto de desenvolver produtos frontend robustos, proporcionando experiências excepcionais para o usuário.",
			},
			homePageButtons: {
			...
			experiencePage: {
				...
				companys: [
					...
					{
						company: "Opentech Soluções em Gerenciamento de Risco e Logística",
						jobTitle: "Assistente de Processos",
						description:
